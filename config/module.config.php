...
return array(
        ...
        'routes' => array(
            ...
            'fiscal' => array(
                ...
                'options' => array(
                    'route' => '/fiscal',
                    'defaults' => array(
                       // '__NAMESPACE__' => 'Fiscal\Controller',
                        'controller' => 'Fiscal\Controller\Index',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            'Fiscal\Controller\Index' => 'Fiscal\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
